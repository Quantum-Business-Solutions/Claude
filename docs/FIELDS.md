...
Fill rates come from up to 200 live records per entity. A low
rate is not necessarily a gap, but a 0% field is one you cannot build on.

## Customer

`53` fields · route `/api/Customer` · sampled 160 records
...
| `remarks` | string | 13% | `Notes for Bank of America main location ` |
...
`26` fields · route `/api/Contact` · sampled 137 records
...
`117` fields · route `/api/Contract/active` · sampled 200 records
...
`67` fields · _no list route — shape from spec only_
...
`68` fields · route `/api/Equipment/AllActive` · sampled 200 records
...
| `remarks` | string | 4% | `Notes for this specific machine can go h` |
| `active` | boolean | 100% | `True` |
...
`24` fields · route `/api/ServiceCall/AllOpen` · sampled 200 records
...
`77` fields · route `/api/SalesOrder/AllOpen` · sampled 200 records
...
`38` fields · _no list route — shape from spec only_
...
`77` fields · _no list route — shape from spec only_
...
`15` fields · _no list route — shape from spec only_
...
`23` fields · _no list route — shape from spec only_
...
`9` fields · _no list route — shape from spec only_
...
`10` fields · _no list route — shape from spec only_
...
`15` fields · route `/api/Item/Makes` · sampled 59 records
...
| `remarks` | string | 2% | `This is a generic make for all new model` |
| `active` | boolean | 100% | `True` |
| `locks` | int | 100% | `0` |
| `creatorID` | string | 100% | `Mark` |
| `updatorID` | string | 100% | `Mark` |
...
`8` fields · route `/api/Item/Models` · sampled 200 records
...
`10` fields · route `/api/ServiceCall/CallTypes` · sampled 26 records
...
`5` fields · route `/api/Customer/States` · sampled 70 records
...
`10` fields · route `/api/Customer/Terms` · sampled 6 records
...
`10` fields · route `/api/Customer/PriceLevels` · sampled 28 records
...
`9` fields · route `/api/SalesOrder/OrderTypes` · sampled 12 records
...
`7` fields · route `/api/ServiceCall/Priorities` · sampled 5 records
...
`5` fields · route `/api/ServiceCall/ProblemCodes` · sampled 4 records
...
`4` fields · route `/api/ServiceCall/RepairCodes` · sampled 6 records
...
`7` fields · route `/api/ServiceCall/SLACodes` · sampled 6 records
...
`7` fields · route `/api/ServiceCall/NoteTypes` · sampled 11 records
...
`15` fields · route `/api/ServiceCall/OnHoldCodes` · sampled 13 records
...
`4` fields · route `/api/ServiceCall/CancelCodes` · sampled 3 records
...
`13` fields · _no list route — shape from spec only_
...
`103` fields · _no list route — shape from spec only_
...
`31` fields · _no list route — shape from spec only_
...
`20` fields · _no list route — shape from spec only_
